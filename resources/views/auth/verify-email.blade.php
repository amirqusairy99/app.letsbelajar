<x-guest-layout>
 ...
 <text-3xl font-semibold tracking-tight class="text-xl font-semibold tracking-tight mb-1 text-light font-semibold">Verify your email</text-3xl font-semibold tracking-tight>
